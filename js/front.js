$(document).ready(function () {
    ...
    var wunderlist = new design(
        ...
        'I built this back when I used Wunderlist to manage my tasks. I loved Wunderlist, but disliked the look. So, I decided to design my own version. To this day, this is my most popular design.'
    );

    var movieSite = new design(
        'Utopian Movie Site',
        'https://assets.materialup.com/uploads/ffd67f47-2726-4e76-8af2-5e93de39f097/preview.png',
        'I was really interested in streaming movies. There was this site I loved but I felt that the interface was too old. I redesigned the site with a focus on ease of access.'
    );
    ...
    var newspaper = new design(
        ...
        'When I was in my high school\'s newspaper team, we didn\'t have an online presence. I decided to build our school a newspaper that they can access anywhere, anytime, online or offline. Unfortunately, the idea wasn\'t implemented but this design has been one of my favorites.'
    );
